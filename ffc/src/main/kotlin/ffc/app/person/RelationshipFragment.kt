...
import kotlinx.android.synthetic.main.person_relationship_fragment.contentContainer
...
class RelationshipFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        person?.let {
            it.relationships.forEach {
                val view = RelationshipView(context!!)
                view.relationship = it
                view.onClick {
                    activity!!.startActivity<PersonActivitiy>("personId" to it.relationship!!.id)
                }
