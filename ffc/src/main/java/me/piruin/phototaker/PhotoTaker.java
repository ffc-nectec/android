...
//    captureTempDir = context.getExternalCacheDir();
      captureTempDir = Environment.getExternalStorageDirectory();
  }
...
//        ui.startActivityForResult(captureIntent, CAPTURE_IMAGE);
        ...
        ui.startActivityForResult(intent,CAPTURE_IMAGE);
        uriImage= FileProvider.getUriForFile(context, context.getPackageName() + ".provider", temp);
